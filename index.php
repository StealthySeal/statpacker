...
<body>
    ...
    ?>
        <div>
            <h2>About us</h2>
            <p>We are a couple of gear enthusists from Massachusetts. When picking new gear, we would always make spreadsheets to compare the options. We decided to make this data publicly avalible.
    ...
    ?>
    <!-- footer unable to be reached after php include statements above ^ -->
    <footer>
        <h2>Contact Us:</h2>
        <ul>
            <li>
